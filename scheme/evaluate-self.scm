...
(define (eprogn exps env)
  (if (pair? exps)
      (if (pair? (cdr exps))
	  ;; Erm...  we use begin to define a begin-like function???
	  ;; Bah, we can simulate it with lambda if we must.
	  ;; Anyway, we also specifically evaluate this in order...
