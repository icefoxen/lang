indexing
   description: "Messing around with Eiffel's file library"
class FILETEST
inherit
   ARGUMENTS  -- handles command-line args
creation
   make
...
feature
   ...
   make is
      require
         has_input_arg: argument( 1 ) /= Void 
	 has_output_arg: argument( 2 ) /= Void
      do
         from !!f1.connect_to( argument( 1 ) )
	 ...
	 print( "Enter text to append to " ); print( argument( 2 ) ) 
	 print( "%N" ) 
	 print( "Terminate with a . on a line by itself.%N" )
	 !!i.make
	 from i.read_line; !!f2.connect_for_appending_to( argument( 2 ) )
